function rectangleInt(bounds) {
    ...
    //Ajout des écouteurs pour modifier le rectangle en déplacant les markers aux coins
...
function creationCoins(rectangle) {
    ...
    //Récupération du coordonnées des deux points définissant le rectangle
...
function majRectangle_bd(event, coin_hg, coin_bg, coin_hd,coin_bd, rectangle){
    //Mise à jour du rectangle quand le coins bas droit est déplacé
    ...
    //Déplacement des marker à la bonne position
...
function majRectangle_hd(event, coin_hg, coin_bg, coin_hd,coin_bd, rectangle){
    //Mise à jour du rectangle quand le coins haut droit est déplacé
...
function majRectangle_bg(event, coin_hg, coin_bg, coin_hd,coin_bd, rectangle){
    //Mise à jour du rectangle quand le coins bas gauche est déplacé
...
function majRectangle_hg(event, coin_hg, coin_bg, coin_hd,coin_bd, rectangle){
    //Mise à jour du rectangle quand le coins haut gauche est déplacé
